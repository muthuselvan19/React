...
const Rescards = () => {
    ...
    let dataUse = async () => {
        try {
            const val = await fetch("https://www.swiggy.com/dapi/restaurants/list/v5?lat=10.9584554&lng=79.38850269999999&is-seo-homepage-enabled=true&page_type=DESKTOP_WEB_LISTING");
